...
RUN apt-get update && apt-get install -y apache2 curl git wget build-essential postgresql systemd apt-transport-https python3-pip python3-venv python3-dev gnupg g++ unzip zip net-tools sudo
